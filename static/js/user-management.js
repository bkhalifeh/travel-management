...
$(function () {
  ...
  if (dtUserTable.length) {
    dtUserTable.DataTable({
      ajax: '/user', // JSON file to add data
      columns: [
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            if ($image) {
              // For Avatar image
              var $output =
                '<img src="' + $image + '" alt="آواتار" class="rounded-circle">';
            } else {
              // For Avatar badge
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var roleBadgeObj = {
              'عضو':
                '<span class="badge badge-center rounded-pill bg-label-primary w-px-30 h-px-30 me-2"><i class="bx bx-universal-access bx-xs"></i></span>',
              'معاون':
                '<span class="badge badge-center rounded-pill bg-label-info w-px-30 h-px-30 me-2"><i class="bx bx-award bx-xs"></i></span>',
              'مدیر':
...
<div class="demo-inline-spacing">
    <button type="button" class="btn btn-icon btn-outline-info" data-bs-target="#SHOW${id}", data-bs-toggle="modal">
        <span class="tf-icons bx bx-show"></span>
    </button>
    <button type="button" class="btn btn-icon btn-outline-warning" data-bs-target="#EDIT${id}", data-bs-toggle="modal">
        <span class="tf-icons bx bx-edit"></span>
    </button>
    <a href="/user/delete/${id}" class="btn btn-icon btn-outline-danger">
